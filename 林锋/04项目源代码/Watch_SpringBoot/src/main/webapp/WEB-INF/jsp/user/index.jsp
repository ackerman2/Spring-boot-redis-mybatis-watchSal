								...
								<ul>
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											...
											<li> <a href="../index"><i class="fa fa-sign-out"></i>返回首页</a> </li>
										</ul>
									</li>
								</ul>
							</div>
...
<!--market updates updates-->
    ...
    <tr>
      ...
      <td>${item.state}</td>
    <%--  <td><a href="edit?id=${item.orderid}"  class="btn btn-primary btn-normal btn-inline btn_form button item_add item_1" target="_self" href="/css/" target="_blank" onclick="if(confirm('确认商品已送达?')==false)return false;">删除</a></td>  --%>
    </tr>
   </c:forEach>
