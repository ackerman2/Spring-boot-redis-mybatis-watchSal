...
<body>	
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	...
	<form class="form-horizontal" role="form" action="doBadd" method="post" enctype="multipart/form-data">
	<%-- <input type="hidden" name="bookId" value="${ book.bookId}"> --%>
  <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label" >品牌名称</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name ="brandname" id="brandname" placeholder="品牌名称">
    </div>
  </div>
    ...
    <div class="col-sm-10">
     <!--  <input type="text" class="form-control" name="descr" id="descr" placeholder="详细信息"> -->
       <textarea name="branddscr"  style="width: 1055px; height: 86px; margin: 0px;" placeholder="详细信息"></textarea> 
    </div>
    </div> 
    <div class="form-group">
