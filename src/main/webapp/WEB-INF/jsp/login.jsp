   ...
   <div class="account-in">
		...
		<div class="col-md-7 account-top">
		  <form action="/dologin" method="post" >
			<div> 	
				<span>用户名*</span>
				<input type="text" name="username" id="u" value="${username}" onclick="document.getElementById('u').value='';document.getElementById('rem').checked=false;"> 
			</div>
			<div> 
 ...
 <% 
	...
	rem=ck.getValue();
		...
		<div class="col-md-5 left-account ">
			<a href="single/2"><img class="img-responsive " src="${pageContext.request.contextPath}/watch/images/b1.jpg"  alt=""/></a>
			<div class="five-in">
			<h3>New</h3><span></span>
			</div>
			<a href="register" class="create">注册账号</a>
